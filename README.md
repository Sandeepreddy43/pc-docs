...
| 2 | Registration with alreday existed mail id in the system. | 1) Click on Register button <br> 2) registration popup should show <br> 3) enter already existed email id in the system <br> | | Email already existed system. plase try to register with different email id.  |
